...
<%@include file="includes/layout/nav_blk.jsp" %>
  ...
  <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light fine_wrap" style="margin: 0 !important;">
    <div class="col-md-5 p-lg-5 mx-auto my-5">
      <h1 class="display-4 fw-normal">FINE FRAGRANCES</h1>
      <p class="lead fw-normal">And an even wittier subheading to boot.<br>Jumpstart your marketing efforts with this example based on Apple’s marketing pages.</p>
    </div>
